...
class ShowQueue(generic_queue.GenericQueue):
    ...
    def addShow(self, tvdb_id, showDir, default_status=None, quality=None, season_folders=None, lang="en", downloadPriority = 0):
        queueItemObj = QueueItemAdd(tvdb_id, showDir, default_status, quality, season_folders, lang, downloadPriority)
...
class QueueItemAdd(ShowQueueItem):
    def __init__(self, tvdb_id, showDir, default_status, quality, season_folders, lang, downloadPriority):
    ...
    def execute(self):
        ...
        try:
            ...
            newShow = TVShow(self.tvdb_id, self.lang, self.downloadPriority)
